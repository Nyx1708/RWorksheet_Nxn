...
ranking_data <- data.frame(Rank = pr, Celebrity = celebrity, Pay = pay)
write.csv(ranking_data, file = "C:/Users/kurts/Desktop/R-Code/RWorksheet_2/PowerRanking.csv", row.names = FALSE)

# Now try to read it
if (file.exists("C:/Users/kurts/Desktop/R-Code/RWorksheet_2/PowerRanking.csv")) {
    power_ranking_data <- read.csv("C:/Users/kurts/Desktop/R-Code/RWorksheet_2/PowerRanking.csv")
    print(power_ranking_data)
} else {
    stop("File 'PowerRanking.csv' does not exist.")
}
...
hotels_vienna_data <- read_excel("C:/Users/kurts/Desktop/R-Code/RWorksheet_2/hotels-vienna.xlsx")
hotels_vienna_data
